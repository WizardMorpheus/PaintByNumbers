...
:: GLFW
powershell -Command "Invoke-WebRequest -OutFile file.zip -Uri https://github.com/glfw/glfw/releases/download/3.4/glfw-3.4.bin.WIN32.zip"
tar -xf file.zip
del file.zip
xcopy glfw-3.4.bin.WIN32\include\* include /E /I /Y
xcopy glfw-3.4.bin.WIN32\lib-vc2022\* lib /E /I /Y
rmdir /S /Q glfw-3.4.bin.WIN32
